            ...
            <div class="container-post">
                ...
                <article>
                    ...
                    <div class="post-image">
                        <img src="../../assets/img/imagencontacto.jpeg" alt="post image 1">
                    </div>
                    <div class="post-text">
                        <p class="text">Alex Rubio - San Miguel Bienvenidos a mi blog, donde exploraré cómo la tecnología puede transformar y mejorar nuestro entorno, centrándome específicamente en cómo un distrito puede prosperar y evolucionar con la implementación de soluciones tecnológicas innovadoras! Acompáñenme mientras analizo estrategias, tendencias y casos de estudio que demuestran cómo la tecnología puede impulsar el desarrollo, la eficiencia y la calidad de vida en un distrito. ¡Juntos, descubriremos las infinitas posibilidades de construir comunidades más inteligentes y conectadas!</p>
